...
static Key keys[] = {
    ...
    { Mod4Mask,                     XK_comma,       spawn,              SHCMD("pamixer -d 5") },
    { Mod4Mask,                     XK_period,      spawn,              SHCMD("pamixer -i 5") },
