 ...
 *
 * ,--------------------------------.      ,----------------------------------.
 * |        |    DEL   ESC    |     |      |     DQUO   ESC   TMUX  BSLS      |
 * |--------+-----+-----+-----+-----|      |------+------+-----+-----+--------|
 * |        |   BSPC   TAB   MMB    |      |      LT    COLN   GT    |        |
 * |--------+-----+-----+-RMB-+-LMB-|  	   |------+------+-----+-----+--------|
 * |        |     |    MINS   |     |      |     QUO    UNDS   |     |        |
 * `--------------------------------'  	   `----------------------------------'
 *  .-------------------------------.      .--------------------------------.
 ...
 * `--------------------------------'  	   `----------------------------------'
 *   .------------------------------.      .-------------------------------.
 *   | ESC/META | ENT/ALT | SPC/SYM |      | SPC/NUM | ENT/SHFT | ESC/CTRL |
 *   '------------------------------'      '-------------------------------'
 */
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT, KC_Z),KC_X, KC_C, KC_V, KC_B,  	KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
		...
		LT(NUMB, KC_SPC), MT(MOD_LSFT, KC_ENT), MT(MOD_LCTL, KC_ESC)		// Right
    ),
 ...
 * `--------------------------------'	   `----------------------------------'
 *  	   	.-----------------------.      .---------------------.
 *  	   	| CMB_TOG |  : 	| (SYM)	|      | (NUM) |  ;  | RESET |
 *  	   	'-----------------------'      '---------------------'
 */
[SYMB] = LAYOUT_gergoplex(
    KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,   KC_GRV,  KC_TILD, KC_TAB,  KC_BSPC, KC_BSLS,
    ...
    KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_BTN1,   KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_UNDS,
                      CMB_TOG, KC_SCLN, KC_TRNS,   KC_TRNS, KC_COLN, RESET
    ),
